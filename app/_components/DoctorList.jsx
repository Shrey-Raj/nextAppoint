        ...
        {doctorList.length > 0
          ? doctorList.map((doctor, index) => index<6&&(
            ...
            >
              ...
              <Link href={"/details/" + doctor?.id} className="w-full mt-auto ">
                <h2
                  className="p-2 px-3 border-[1px] border-primary text-primary rounded-full w-full text-center text-[11px] mt-2 cursor-pointer hover:bg-primary hover:text-white hover:text-[12px] transition-all ease-in-out"
                >
                  Book Now
                </h2>
              </Link>
